...
export const PricingSection = ({ isFullPage = false }: { isFullPage?: boolean }) => {
    ...
    return (
        <section 
            id="pricing" 
            className={clsx("bg-surface", isFullPage ? "py-12" : "py-36")}
        >
            <div className="container mx-auto px-4">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className={clsx(
                                            ...
                                            {billing === 'annual' 
                                                ? (isEn ? 'Setup Fee: FREE' : 'Configuración: GRATIS') 
                                                : `${t('landing.pricing.setup_fee')}: $${plan.setupFee} USD`
                                            }
                                        </div>
                                        ...
                                        <a
                                            ...
                                            className="inline-block w-full text-center bg-accent text-white font-bold uppercase tracking-wider py-3 px-8 rounded-md transition-all duration-300 shadow-lg shadow-[#f30519]/50 hover:bg-red-800 hover:scale-105"
                                        >
                ...
                {/* CTA Section */}
                {!isFullPage && (
                    <div className="mt-16 text-center bg-black/40 border border-white/10 rounded-xl p-8 max-w-3xl mx-auto">
                        <h3 className="text-2xl font-bold text-white mb-2">
