...
export const attributeService = {
    ...
    updateAttribute: async (id: string, data: AttributeUpdateData): Promise<Attribute> => {
        const response = await api.put<{ attribute: Attribute }>(`/api/admin/attributes/${id}`, data);
        return response.data.attribute;
    },

    deleteAttribute: async (id: string): Promise<{ success: boolean }> => {
    ...
    updateAttributeValue: async (attributeId: string, valueId: string, data: AttributeValueUpdateData): Promise<AttributeValue> => {
    ...
    deleteAttributeValue: async (attributeId: string, valueId: string): Promise<{ success: boolean }> => {
